...
public class ListKategoriAdapter extends ArrayAdapter<Doding> {
    Activity activity;
    int layoutResourceId;
    ArrayList<Doding> data = new ArrayList<Doding>();
    Doding doding;
    public ListKategoriAdapter(Activity activity,int layoutResourceId,ArrayList<Doding> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row==null)
        {
            ...
            holder.judul= (TextView) row.findViewById(R.id.textDoding);
